...
/***/ function(module, exports, __webpack_require__) {
	...
	var MeToolBar = __webpack_require__(170);
	var MeMusic = __webpack_require__(171)
	var MeTouchTrigger = __webpack_require__(172);
	var MeVPads = __webpack_require__(175);
	var MeInteractImage = __webpack_require__(176);
	var MeArticle = __webpack_require__(177);
	var MePageMgr = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(34);
	var Hammer = __webpack_require__(173);
	var _assign = __webpack_require__(5);
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		var MeTouchTrigger = React.createClass({
			...
			detectionActive: function (enable) {
				if (this.props.cxt.interactHandler != null && this.props.listenEvt.triggerEvt != null) {
					if (enable == false) this.props.cxt.interactHandler.off(this.props.listenEvt.triggerEvt, this.refs.meswipe);else {
						this.props.cxt.interactHandler.on(this.props.listenEvt.triggerEvt, this.refs.meswipe, this._triggerEvent);
					}
				}
			},
			...
			componentWillMount: function () {
				if (this.props.listenEvt.active != null) this.props.cxt.ee.addListener(this.props.listenEvt.active, this._detectionActive);
			},
			componentWillUnmount: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hammer = (typeof window !== 'undefined') ? __webpack_require__(174) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 **/
		var MeHammer = function (hammer, default_handler) {
			...
			this.hammer.on("swipeleft swiperight swipeup swipedown pan", function (evt) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		...
		var MeInteractImage = React.createClass({
			...
			render: function () {
				...
				return React.createElement("img", { ref: "interactArea", src: this.props.src, style: this.props.normalStyle });
			}
		});
