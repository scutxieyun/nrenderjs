...
/***/ function(module, exports, __webpack_require__) {
	...
	var MePage = __webpack_require__(1);
	var MeAnimation = __webpack_require__(169);
	var MeToolBar = __webpack_require__(172);
	var MeMusic = __webpack_require__(173)
	var MeTouchTrigger = __webpack_require__(174);
	var MeVPads = __webpack_require__(178);
	var MePanArea = __webpack_require__(179);
	var MeArticle = __webpack_require__(180);
	var MePageMgr = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(39);
		...
		var MePage = React.createClass({
			...
			render: function () {
				...
				return React.createElement(
					"div",
					{ className: "me-page", id: "page" + this.props.idx, style: this.props.normalStyle },
					this.props.children
				);
			} });
		return MePage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		...
		var ReactDOM = __webpack_require__(39);
		var _assign = __webpack_require__(5);
		var MeComponentMixin = __webpack_require__(170);
		var MeAnimationMxin = __webpack_require__(171);
		var MeAnimation = React.createClass({
			...
			componentWillMount: function () {
				if (this.props.listenEvt.active != null) this.props.cxt.ee.addListener(this.props.listenEvt.active, this.animationActive);
				if (this.props.listenEvt.deactive != null) this.props.cxt.ee.addListener(this.props.listenEvt.deactive, this.animationDeactive);
			},
			componentWillUnmount: function () {
				if (this.props.listenEvt.active != null) this.props.cxt.ee.removeListener(this.props.listenEvt.active, this.animationActive);
				if (this.props.listenEvt.deactive != null) this.props.cxt.ee.removeListener(this.props.listenEvt.deactive, this.animationDeactive);
			},
			render: function () {
				...
				return React.createElement(
					"div",
					{ className: className, style: _assign(this.props.animation, this.props.normalStyle) },
					" ",
					this.props.children
				);
			} });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function(){
		/**��Page����*/
		/** ����display�Ŀ��ǣ�
			displayֻ���ṩһ����Ϣ�ο�������Ӱ���ؼ�����ʾ�����ϲ��ؼ��򶨡��������ϲ��ؼ�ȥ���ǳ�ͻ����
		**/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		...
		var MeMusic = React.createClass({
			...
			handleClick: function () {
				if (!this.refs.player.paused) this.refs.player.pause();else this.refs.player.play();
			},
			componentWillUnmount: function () {
			...
			render: function () {
				return React.createElement(
					"div",
					{ id: "magazine-music-wrapper", className: "half-zoom", style: { display: "block" } },
					React.createElement(
						"span",
						null,
						"开启音乐"
					),
					React.createElement("audio", { src: this.props.src, preload: "none", loop: "loop", className: "main-audio", autoplay: true, ref: "player" }),
					React.createElement("div", { className: "fly-note1  note" }),
					React.createElement("div", { className: "fly-note2  note" }),
					React.createElement("menu", { onClick: this.handleClick, id: this.props.id, className: "spin" })
				);
			}
		});
		return MeMusic;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		var React = __webpack_require__(2);
		var ReactDOM = __webpack_require__(39);
		var Hammer = __webpack_require__(175);
		var _assign = __webpack_require__(5);
		var MeCommandMixin = __webpack_require__(177);
		var MeComponentMixin = __webpack_require__(170);
		var MeTouchTrigger = React.createClass({
			...
			getDefaultProps: function () {
				return {
					...
					listenEvt: { //
						active: null, //激活检测的事件
						triggerEvt: "swipeleft" },
					//需要检测的交互事件
					id: this.displayName + MeComponentMixin.getIncId() };
			},
			//因为这个控件需要pageActive，为了减少应用的麻烦，自己先定义一个id
	   ...
	   this.state.triggeredCount ++;*/
			...
			detectionActive: function (enable) {
				if (this.props.cxt.interactHandler != null && this.props.triggerActions != null) {
					if (enable == false) {
						this.props.cxt.interactHandler.off(MeTouchTrigger.getTriggerEvents(this.props.triggerActions), this.refs.meswipe);
					} else {
						this.props.cxt.interactHandler.on(MeTouchTrigger.getTriggerEvents(this.props.triggerActions), this.refs.meswipe, this._triggerEvent);
					}
				}
			},
			...
			pageDeactive: function () {
				if (this.props.listenEvt.active != null) this.props.cxt.ee.removeListener(this.props.listenEvt.active, this._detectionActive);
				this.detectionActive(false);
			},
			render: function () {
				return React.createElement(
					"div",
					{ ref: "meswipe", id: "registerTouch", style: this.props.normalStyle },
					this.props.children
				);
			} });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hammer = (typeof window !== 'undefined') ? __webpack_require__(176) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		...
		var PadBuffer = React.createClass({
			...
			render: function () {
				...
				if (pageInstance != null) return React.createElement(
					"div",
					{ id: this.props.id, className: className },
					pageInstance
				);else return React.createElement("div", { id: this.props.id, me_page_idx: this.state.pageIdx, className: className });
			}
		});
	 ...
	 **/
		var MeHammer = function (hammer, default_handler) {
			...
			this.hammer.on("swipeleft swiperight swipeup swipedown pan tap", function (evt) {
				self.handleHammerEvent(evt);
			});
			this.hammer.on("tap", function (evt) {
				self.handleHammerEvent(evt);
			});
		};
				...
				while (curElm != null && curElm != this.hammer.element) {
					for (i = 0; i < evt_listeners.length; i++) {
						if (evt_listeners[i].elem == curElm) {
							//没能理解apply的机制，按道理，1st参数应该对应this，但不是，严谨的做法应该用bind
	 ...
	 **/
		var MeVPads = React.createClass({
			...
			componentWillMount: function () {
				...
				if (this.props.bufferLen == null || this.props.bufferLen < 3 || this.props.bufferLen > 10) this.props.bufferLen = 3;
			...
			_cachePage: function (pageIdx, state, loc) {
				...
				cache.lock = true;
				if (state == "active") cache.rate += 2;else cache.rate += 1;
			...
			loadPageByPos: function (posXIdx, posYIdx) {
				//显示指定位置的页，对应的页在layout中定义
			...
			_registerHammer: function (ref) {
				//this.hammer = ref;
				this.props.article.getCxt().interactHandler = new MeHammer(ref.hammer, { "swipeleft": this.moveXNext, "swiperight": this.moveXPrev,
			...
			render: function () {
				...
				for (i = 0; i < this.props.bufferLen; i++) {
					items.push(React.createElement(PadBuffer, { id: i, posIdx: i, ref: self._registerBuffer, article: self.props.article }));
				}
				return React.createElement(
					Hammer,
					{ ref: this._registerHammer, id: "oper-area", className: "magazine-page-container show", vertical: true },
					React.createElement(
						"div",
						null,
						items,
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
		...
		var MePanArea = React.createClass({
			...
			render: function () {
				...
				return React.createElement(
					"div",
					{ ref: "interactArea", style: this.props.normalStyle },
					this.props.children
				);
			}
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function(){
		var MePageMgr = function(pageSize){
			this.pageArr = new Array(pageSize);//ҳ�����󣬴���page��react����
		};
